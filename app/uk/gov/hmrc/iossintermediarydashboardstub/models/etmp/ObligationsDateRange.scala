...
object ObligationsDateRange {
  ...
  implicit def queryStringBindable(implicit localDateBinder: QueryStringBindable[String]): QueryStringBindable[ObligationsDateRange] = new QueryStringBindable[ObligationsDateRange] {
